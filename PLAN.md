...
- **Dev2 stack:** `dev2-iris-a` + `dev2-iris-b` healthy (fresh build from `98399b73`, 2026-09-22 — S24-D2 outbox filter + S38 webfinger proxy + S36 home-feed fix + S17 Likes tab scoping + S22/S23 follow-notification + S39 notification delivery all deployed; S36 live-verified 2026-09-22).
