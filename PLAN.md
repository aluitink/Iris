...
**46.3: Card system** (next up). See [docs/plans/wasm-stabilization.md](docs/plans/wasm-stabilization.md) for scope.
...
1. **46.3: Card system** — post card hierarchy (author bolder, avatars in cards), button hierarchy (primary/secondary/destructive), community row structure (P1-2, P2-5, P2-6, P3-12).
2. **46.4: Object detail + notifications** — notification row human-readable, object detail polish (P3-14).
3. **46.5: Mobile layout** — mobile nav, mobile spacing, mobile card layout.
4. **46.6: Forms + tabs + footer** — tab style, compose tips, search description, footer links.
