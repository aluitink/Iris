...
- **Still open:** **S35** (Mastodon cluster — remote-actor discovery 404 attributed to the Mastodon cluster, not Iris) + **S40** (NEW Pass 268 — orphaned follow edge on community delete; needs dev fix). **S3 + S21 re-verified closed** (Pass 261; S21 residual server fix `1f941cfb` live-verified Pass 268); **S6 re-verified closed live** (Pass 264 — remote Join/Leave on A's `qa-pass261-test` community drives a server-side Follow/Undo, `POST /ap/v1/u/ii-b1/outbox` 202, no CSP-blocked browser POST, 0 console errors). (S24-D2 outbox-integrity was the last dev-owned open facet — REFUTED as not a defect, see [s24](docs/qa/s24-cross-instance-follow-state-inconsistent.md); S24 fully closed.)
...
- **CLOSED:** S2, S3 (Pass 261), S4, S6 (Pass 264), S14, S17, S19, S20, S21 (Pass 261), S24 (all facets — D1/D2/D3/D4; D2 outbox-integrity REFUTED as not a defect), S26, S27, S28, S29, S30, S31, S32, S33, S34, S36, S37, S38, S39.
