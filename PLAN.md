...
- **Open:** S2, S3, S14, S17, S19, S20, S21, S35 (S1), **S36 (S2, OPEN — 66th consecutive pass; home feed is the ONLY broken surface of 8; awaiting QA re-verify of `14eb0db1`+`61c328fa`)**, **S4 (S2, FIXED `83eb22aa`+`cca01fa7`, awaiting QA re-verify)**. **S38 (S3, FIXED dev2 2026-09-22, awaiting QA re-verify)**. **S24-D2 (S2, FIXED dev2 `activity.Actor` outbox filter + `61c328fa` feed-surface filter, awaiting QA re-verify)**. **S24-D4 (S2, FIXED `2804fb55`, live-verified)**. Count in [docs/qa/README.md](docs/qa/README.md).
