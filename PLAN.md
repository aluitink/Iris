...
- **143 — Consistency review fixes (from Phase 142 findings):** (1) F-142.17 duplicate "Load more" button — **done** (`918f835`); (2) F-142.13/14 boost attribution in actor Posts tab — **done** (`7179ae3`); (3) F-142.1/2 community doc `?refresh` + invalidation — **done** (`626072e`); (4) F-142.4 — **reviewed, no change**; (5) F-142.19 — **reviewed, no change**; (6) F-142.11 — **reviewed, no change**; (7) F-142.5 community 500 logging — **done** (`0939aa4`); (8) F-142.3 shared `?refresh` predicate — **done** (`0939aa4`); remaining: F-142.6/7/8 cache-contract minors; cosmetic (F-142.10/12/15/18/20). See [phase-142 findings](docs/plans/phase-142-consistency-review.md).
