...
**29.3 (follow-up) — COMPLETE.** All 13 RISKY single-instance + 19 two-instance + 3 three-instance federation classes converted to shared-host fixtures. Full fast suite green (899/899, 4m56s). See [docs/changes/258](docs/changes/258-29.3-signature-validation-risky-classes.md) through [docs/changes/271](docs/changes/271-29.3-outbox-create-fanout.md).
