...
- 79.2 — Lemmy interop verification: live-verify Lemmy Group/Person/Page rendering via Playwright (Docker can't reach lemmy.ml; verify rendering logic with local fixtures or console inspection).
