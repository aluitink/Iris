...
| 70 | Content & media improvement — media rendering, remote browsing, post-and-view-in-instance | **active** — 70.1 (media render) done (verification, [701](docs/changes/701-media-render-verified.md)); 70.2 (browse remote users) + 70.3 (post + view in instance) remaining |
