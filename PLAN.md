...
- **143 — Consistency review fixes (from Phase 142 findings):** (1) F-142.17 — **done** (`918f835`); (2) F-142.13/14 — **done** (`7179ae3`); (3) F-142.1/2 — **done** (`626072e`); (4) F-142.4 — **reviewed, no change**; (5) F-142.19 — **reviewed, no change**; (6) F-142.11 — **reviewed, no change**; (7) F-142.5 — **done** (`0939aa4`); (8) F-142.3 — **done** (`0939aa4`, `18f0fc4`); (9) F-142.7 — **deferred** (invalidation refactor needed); (10) F-142.6/8 cache-contract — **done** (`430d12b`); remaining: cosmetic (F-142.10/12/15/18/20). See [phase-142 findings](docs/plans/phase-142-consistency-review.md).
