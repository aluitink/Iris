...
1. **General UI/UX review** (recurring) — Next pass after improvements land. Pass 6 (2026-09-19): post-147.2-follow-up verification — all 8 signed-in routes + community-detail feed verified, 0 new defects (1 transient `ERR_NETWORK_CHANGED`, not a code defect). [change doc](docs/changes/997-ui-ux-review.md)
...
*(Pass 2 of the recurring UI/UX review, plus Scenarios 2, 3, 4, 6, 7, 8 of 139.3, the s6-F1/s6-F2 follow-ups, and 140.1, are in [docs/ROADMAP.md](docs/ROADMAP.md) — see the one-liner entries there.)*
