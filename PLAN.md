...
- **Open:** S2, S3, S14, S17, S19, S20, S21, S35 (S1), **S36 (S2, OPEN — 66th consecutive pass; home feed is the ONLY broken surface of 8; awaiting dev fix)**, **S4 (S2, FIXED `83eb22aa`+`cca01fa7`, awaiting QA re-verify)**. **S38 (S3, FIXED dev2 2026-09-22, awaiting QA re-verify)**. **S24-D2 (S2, FIXED dev2 2026-09-22, awaiting QA re-verify)**. Count in [docs/qa/README.md](docs/qa/README.md).
