...
- **4 open + 1 new. No blockers (all S2/S3-sev).** (Pass 91: S19 facet 3 FIXED — Edit Save persists; S19 facet 2 CANNOT RE-VERIFY — NEW BUG: follow notifications not created for local follows; S4 re-confirmed 17th pass; S17 re-confirmed 39 outbox requests; S16-UX re-confirmed.)
- **Top priority:** S19 facet 2 (Accept/Decline buttons — CANNOT RE-VERIFY; NEW BUG: follow from qa91test → andrew creates edge but NO notification; API returns 0 items), S4 (remote communities missing from Following tab — 17th pass), S17 (profile tabs over-fetch — 39 outbox requests for 3 tabs), S16-UX (poll "You voted" badge missing on object detail page). S2 (proxy 401 — 2 errors, no change) / S14 (proxy 401 + CSP on actor detail) still blocked on dev.
- **Last pass:** 91 (2026-09-20). **Resume checkpoint:** see [docs/qa/passes.md](docs/qa/passes.md) — S13, S15, S7, S8, S3 (UI) fixed; S18 partially fixed; S20 FIXED; S21 FIXED; S2 partially improved; S16-UX partially improved; S19 facet 1 FIXED; S19 facet 3 FIXED (Edit Save persists); S19 facet 2 CANNOT RE-VERIFY (NEW BUG: follow notifications not created). Remaining open: S2, S4 (remote), S14, S16-UX, S17, S18 (partial), S19 (facet 2), NEW (follow notifications not created).
