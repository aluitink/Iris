...
- **Awaiting QA re-verify (fixed in code):** S2, S3, S4, S14, S17, S19, S20, S21, S24-D2, S24-D4, S33 (cross-instance leg re-verified dev1 `774b68ba` 2026-09-22 — was regressed on the older `38ae87c` QA build), S36, S38.
- **Operator action (blocked):** S35 (Mastodon cluster).
