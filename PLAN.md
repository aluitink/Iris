...
- **Still open:** **S3** (object-detail 404) FIXED; its residual **Like/Boost-button count UI facet is CLOSED** (live-re-verified 2026-09-22 on dev1 — the buttons now read the denormalized `likedCount`/`sharedCount` and update live). **S21** — fixed in code, awaiting QA re-verify. (**S24-D2 outbox-integrity was the last dev-owned open facet — now REFUTED as not a defect, see [s24](docs/qa/s24-cross-instance-follow-state-inconsistent.md); S24 is fully closed.**)
...
- **CLOSED:** S2, S4, S14, S17, S19, S20, S24 (all facets — D1/D2/D3/D4; D2 outbox-integrity REFUTED as not a defect), S26, S27, S28, S29, S30, S31, S32, S33, S34, S36, S37, S38, S39.
