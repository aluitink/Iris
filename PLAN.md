...
4. **139.3 Scenario 9 (migration safety)** — Apply the current EF Core migrations to a populated/older-schema DB copy; confirm migration completes cleanly, no data loss, and the app boots against the migrated schema. (Next 139.3 review scenario after s8.)
