...
- **143 — Consistency review fixes (from Phase 142 findings):** implement fixes in priority order: (1) F-142.17 duplicate "Load more" button; (2) F-142.13/14 boost attribution in actor Posts tab; (3) F-142.1/2 community doc `?refresh` + invalidation; (4) F-142.4 community Add/Remove object-IRI guard; (5) F-142.19 actor profile summary display; (6) F-142.11 community follow button; (7) F-142.5 community 500 logging; (8) F-142.3/6/7/8 cache-contract cleanup; (9) cosmetic (F-142.10/12/15/18/20). See [phase-142 findings](docs/plans/phase-142-consistency-review.md).
