...
**101 - Feed Improvements** - The Announced/Boosted item should be dislayed in the body of the boost and should show the age of the boost. The In Reply to replied item should be under the reply. Items with mentions and hashtags don't need an additional section listing the mention and hashtags, they are in the body of the post. The body of the post is a link to the post, but the on hover makes the text change color. The feed should show posts from you and people you follow, the replies to the posts of people you follow should not be their own items, but rather require you to open the person post to see those replies, this way other peoples followers do not flood your view. The only exception to this is if one of your followers boosts someone else post, it can show as a boost from your follower but per the above view of the boosted item. It should look similar to the in reply to but you should be a note card within a card, so we can see the original posters information.
**102 - Card Improvements** - The card itself could use a larger icon, but maybe smaller when on mobile, cards that are content should have moderation buttons on the right side - but they should be minimalistic.
**103 - Actor detail improvements** - The actors description contains HTML tags when it comes from mastodon, we should handle for this. If an actors description is very long the follow/block/mute/report buttons are orented oddly in the upper right half and half style. The users icon and image should be clickable to get a bigger view. The Followers and Following tab are always a list of Links to actors, we could hydrate this cards to show actor cards that allow you to see their icon/image and the follow/unfollow buttons. We can get rid of the "This is you." for your actor view.
**104 - Notifications improvements** - The replies should state replied to and ideally the person that made the post they replied to. These notifications should show a card style for likes/replies/boosts similar to what we are trying to show in the feed. I am seeing a generic "boosted your post" but the boost was not for my post (same issue we had with "replied to your post" from earlier)
