...
1. **General UI/UX review** (recurring) — Next pass after improvements land. Pass 4 (2026-09-19): post-139.2-s5c verification — all 8 signed-in routes verified, 0 console errors, 0 new defects. [change doc](docs/changes/997-ui-ux-review.md)
