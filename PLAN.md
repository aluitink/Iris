...
- **Still open:** **S35 only** (Mastodon cluster — remote-actor discovery 404 is attributed to the Mastodon cluster, not Iris). **S3 + S21 now re-verified closed** (Pass 261); **S6** fix present in code/build (not re-exercised live — no remote-join target). (S24-D2 outbox-integrity was the last dev-owned open facet — REFUTED as not a defect, see [s24](docs/qa/s24-cross-instance-follow-state-inconsistent.md); S24 fully closed.)
...
- **CLOSED:** S2, S3 (Pass 261), S4, S14, S17, S19, S20, S21 (Pass 261), S24 (all facets — D1/D2/D3/D4; D2 outbox-integrity REFUTED as not a defect), S26, S27, S28, S29, S30, S31, S32, S33, S34, S36, S37, S38, S39. Fixed (S6 `68ae703` present in fresh build; not re-exercised live).
