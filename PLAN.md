...
- **Open (2026-09-21 fresh-cluster interop re-test):** S2, S3, S4, S14, S17, S19, S20, S21, S24, S25, S28, S30, S32, **S35 (S1)** — 14 open (count in [docs/qa/README.md](docs/qa/README.md)). **Fixed this re-test:** S26 (reply threading), S29 (community webfinger), S34 (gated follow), **S27 (remote Like applied on author, `27b1ba6`)**, **S31 (edit preserves `published`, `45f3038`)**, **S33 (unfollow `Undo` propagates, `d6914d6`)** — the last three were reproduced in the initial run only because the QA cluster images pre-dated the fixes; rebuilding the two Iris services from HEAD (`27b1ba6`) made them live and they no longer reproduce (Pass 100).
...
- **Last passes:** 97 (Iris↔Iris A1–A10), 98 (M1 + S35), 99 (L1), **100 (re-verified S27/S31/S33 FIXED on rebuilt cluster @ HEAD `27b1ba6`)**. **Resume checkpoint:** see [docs/qa/passes.md](docs/qa/passes.md) — re-verify S24/S25/S28/S30/S32 on the current build, or resume a peer suite once unblocked; **M2–M12 + L2–L12 still blocked** pending operator-provided peer accounts.
