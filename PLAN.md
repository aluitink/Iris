...
- **138.4 (unblock) — instance-actor document at the instance root:** Iris serves the instance actor's public document at `GET /` for ActivityPub clients, fixing the defect that blocked Lemmy from resolving any Iris object. 5 integration tests + live-verified. [Change doc](docs/changes/13804-phase138-iris-instance-actor-at-root.md).
