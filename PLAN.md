...
S69 | NEW | qa | cross-instance direct note not federated to recipient (remote IRI not found, no notification) (REPRODUCED prior s58qa->s56qa; re-test replyauth->s68qa NOT reproduced: notification received + object page opens via proxy; local AP IRI 404 + search miss remain)
