...
**Re-verification evidence (Pass 77, 2026-09-20, andrew, Dev fix deployed):** Poll `06GBVZDNA8JPCCFC8WW2JGAFZR` — Object detail page: fresh load shows A:1/B:0/**1 votes** + **NO "You voted" badge**. Vote count consistent (1). Badge still missing on object detail page. Core data-integrity still FIXED. UX gap unchanged: badge missing on object detail page. STILL OPEN.

**Re-verification evidence (Pass 83, 2026-09-20, andrew, container 12:15:50):** Poll `06GBVZDNA8JPCCFC8WW2JGAFZR` (correct IRI: `…/objects/06GBVZDNA8JPCCFC8WW2JGAFZR`) — Object detail page: fresh load shows **1 votes** + **NO "You voted" badge**. DB confirms `poll.voters = [andrew]`, `totalVotes = 1`, `options[0].votesCount = 1`. Vote count consistent. Badge still missing on object detail page. Note: the old IRI format (`…/u/andrew/06GBVZDNA8JPCCFC8WW2JGAFZR` without `/objects/` prefix) returns "Object not found" — the IRI format changed but the old URL is not redirected. Core data-integrity still FIXED. UX gap unchanged: badge missing on object detail page. STILL OPEN.
...
**Re-verification evidence (Pass 93, 2026-09-20, andrew, container 13:26:35):** Same container as Pass 92. S16-UX not re-tested this pass (focused on S22 root cause). **Still OPEN** (1 votes, NO badge, unchanged since Pass 90).
...
**Re-verification evidence (Pass 96, 2026-09-20, andrew, container 14:09:44):** Poll `06GBVZDNA8JPCCFC8WW2JGAFZR` — Object detail page: fresh load shows **1 votes** + **NO "You voted" badge**. 2 console errors (ERR_NETWORK_CHANGED — environmental). STILL OPEN.
